...
# TODO: add model to over-ride solutions with screenshots model as well
...
class FindingScreenshot(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.finding_subtle)
...
class Finding(models.Model):
    ...
    nessus_scan_name = models.CharField(max_length=190, null=False, blank=False, db_index=True, help_text="Name of the Nessus scan or friendly engagment identifier to link to the engagement group.")
...
class EngagementFindingGroup(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.engagement_name)
...
class TestFrom(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.test_from_name)
...
class RiskLevel(models.Model):
    ...
    def __str__(self):
        return '{} - {} - {}'.format(self.risk_level_name, self.risk_matrix_col, self.risk_matrix_row)
...
class ScoreOverride(models.Model):
    ...
    def __str__(self):
        return '{} - {}'.format(self.score_override_name, self.score_override_value)
...
class Strength(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.strength_subtle)
...
class Improvement(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.improvement_subtle)
...
class SolutionOverride(models.Model):
    ...
    def __str__(self):
        return f"{self.vulnerability_title}"
...
class Report(models.Model):
    ...
    def __str__(self):
        return '{} - {}'.format(self.report_for, self.start_date)
...
class NessusConfig(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.scanner_name)
...
class NessusImportHistory(models.Model):
    ...
    def __str__(self):
        return '{} - {} - {}'.format(self.scanner.scanner_name, self.scan_id, self.history_id)
